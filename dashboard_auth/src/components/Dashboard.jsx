...
const Dashboard = () => {
  return (
    <div className="container flex max-h-screen flex-col md:flex-row">

      {/* left Container */}
      <aside className="min-w-64 h-screen bg-white shadow-md p-4 flex flex-col sm:w-full md:w-1/4 lg:w-1/5 xl:w-1/6 overflow-y-auto">
        <div className='mb-4'>
        ...
        <div className='mt-auto mb-4'>
          <div className="px-4 py-4 bg-gradient-to-l from-[#4623E9] via-[#EAABF0] to-[#EAABF0] rounded-xl">
            <p className='text-[10px] text-white text-center'>Upgrade to PRO to get <br /> access all features</p>
            <button className="w-full bg-white text-[#4623E9] font-bold text-xs py-2 my-2 rounded-xl hover:text-white hover:bg-purple-700">
              Get Pro now
            </button>
          </div>
        </div>
      ...
      <main className="flex-1 p-6 bg-gray-100 mt-auto">
        ...
        <header className="flex flex-col md:flex-row justify-between items-center mb-6">
          <h1 className="text-2xl font-semibold mb-4 md:mb-0">Hello Evano 👋</h1>
          <div className='flex items-center p-2 border rounded-lg bg-white'>
            <FontAwesomeIcon icon={faSearch} className="text-gray-500 mr-2" />
            <input type="text" placeholder="Search" className="border border-none focus:outline-none" />
          </div>
        ...
        <section className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="mb-4 flex flex-col sm:flex-row items-center">
            ...
            <div className='lg:ml-auto flex flex-col sm:flex-row gap-4'>
              ...
              <select className="p-2 border rounded-lg bg-gray-200 text-sm font-bold">
                <option>
                  Sort by: Newest
                </option>
              </select>
            ...
            <table className="w-full table-auto md:table-fixed">
              ...
              <tbody className="block md:table-row-group">
                <tr className="border-b block md:table-row">
                  <td className="p-2 block md:table-cell">Jane Cooper</td>
                  <td className="p-2 block md:table-cell">Microsoft</td>
                ...
                <tr className="border-b block md:table-row">
                  ...
                  <td className="p-2 block md:table-cell">Yahoo</td>
                ...
                <tr className="border-b block md:table-row">
                  ...
                  <td className="p-2 block md:table-cell">Adobe</td>
                ...
                <tr className="border-b block md:table-row">
                  ...
                  <td className="p-2 block md:table-cell">Tesla</td>
                ...
                <tr className="border-b block md:table-row">
                  ...
                  <td className="p-2 block md:table-cell">Google</td>
                ...
                <tr className="border-b block md:table-row">
                  ...
                  <td className="p-2 block md:table-cell">Facebook</td>
